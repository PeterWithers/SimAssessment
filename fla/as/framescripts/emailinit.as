...
cont = "";
// setup email Array
var emailwhen=new Array();
var emailfrom=new Array();
var emailref=new Array();
var emailcont=new Array();
var email=new Array(emailwhen,emailfrom,emailref,emailcont);
// setup archiv Array
var archivwhen=new Array();
var archivfrom=new Array();
...
emailref.push("question");
emailcont.push("I have a question about our subject.");
// write "second" email
emailwhen.push("week 1");
emailfrom.push("student");
emailref.push("complaint");
emailcont.push("I really dont like the subject, because...");
// test write 4.email
emailwhen.push("week 1");
emailfrom.push("student");
emailref.push("test 4");
emailcont.push("Just empty.");
// test write 5.email
emailwhen.push("week 1");
emailfrom.push("student");
emailref.push("test 5");
emailcont.push("Just empty.");
// test write 6.email
emailwhen.push("week 1");
emailfrom.push("student");
emailref.push("test 6");
emailcont.push("Just empty.");
// test write 7.email
emailwhen.push("week 1");
emailfrom.push("student");
