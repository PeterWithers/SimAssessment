...
<!--- 					<cfoutput>
					...
					<cfoutput>
	WeekOfAssignments[#attributescounter#] = {ASS_ID: #get_ass.ass_id[attributescounter]#, ASS_NAME: '#get_ass.ASS_NAME[attributescounter]#', DUE_WEEK: #get_ass.DUE_WEEK[attributescounter]#, FEEDBACK: #get_ass.FEEDBACK[attributescounter]#, MARKER: '#get_ass.MARKER[attributescounter]#', WEIGHTING: '#get_ass.WEIGHTING[attributescounter]#', WHICH_ASS: #get_ass.WHICH_ASS[attributescounter]#, goal_ids: '#ValueList(qDetail.goal_id)#'};<br>
					</cfoutput>
	</cfif>
